...
#### 5.2 CONCLUSIONES
El indice meteorologico de incendios nos indica qué tan favorables son las condiciones del tiempo para que se inicie, se propague y sea difícil de controlar un incendio forestal y esta estrechamente relacionado con la temperatura, velocidad del viento humedad relativa y precipitaciones.
Por  tanto es uno de las mejores variables para determinar si puede haber un incendio asi como la gravedad de este.
