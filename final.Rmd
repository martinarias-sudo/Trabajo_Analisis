...
puesto que aunque a veces sea por poco, la DM_med \< DM. Vemos también que la asimetría es positiva excepto para Bejaia cuando no hay fuego. Los valores cercanos a 0, por lo que son ligeramente asimétricos. Esto explica que la diferencia entre la DM y la DM_med sea mínima.
...
asimetría en todos los casos positiva, por lo que el mejor representante
